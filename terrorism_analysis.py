"""              Terrorism Analysis with Insights Project   """
...
## Data loading 
def load_data():
  dataset_name = "global_terror_demo.csv"
       ...
       dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
            ...
            dcc.Dropdown(id="Chart_Dropdown", options = chart_dropdown_values, placeholder="Select option", value = "region_txt"), 
                  ...
                  html.Br(),
                  html.Hr(),
                  dcc.Input(id="search", placeholder="Search for the values of any of the filters above"),
            html.Hr(),
            html.Br(),
            dcc.RangeSlider(
                    id='cyear_slider',
...
def update_app_ui(Tabs, month_value, date_value,region_value,country_value,state_value,city_value,attack_value,year_value,chart_dp_value, search,
    ...
    # You should always set the figure for blank(none), since this callback 
    # is called once when it is drawing for first time        
    fig = None
     
    if Tabs == "Map":
        
    ## Industy Best practice for testing
  ...
  ## COnditional logics
        ...
        if subtabs2 == "WorldChart":
            ...
            chart_df = chart_df[(chart_df["region_txt"]=="South Asia") &(chart_df["country_txt"]=="India")&(chart_df["natlty1_txt"]=="India")]
...
def main():
  ...
  #Suggested as Industry Best practice
  df = None
  app = None
